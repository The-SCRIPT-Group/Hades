...
def root():
    ...
    return render_template('form.html', event='Ethical Hacking', group=False, department_generic=True,
                           date='29-30th July 2019', db='eh_july_2019', extra_message='Please download <a href="https://drive.google.com/drive/folders/1JlTKhFfykKRayT5Rfqh1U1_ePrnfczU6">this</a> before coming for the event',
